...
-- tables: public.study_plans, public.exercise_templates, public.review_sessions, public.review_session_feedback
-- enums: public.taxonomy_level, public.review_status
...
-- create enums representing bloom taxonomy levels and review statuses
